...
const fakeimg = fs.readFileSync('./media/name.jpg')
const faketroli = { "key" : {"remoteJid": "299277777@g.us","fromMe": false,"participant": '0@s.whatsapp.net'},message: {orderMessage: {itemCount : -9999999,status: 1,surface : 1,message: `_\`C̷r̷e̷a̷t̷e̷d̷ B̷y̷ K̷e̷v̷i̷n̷ 📍\n🔖 Prefix:「 + 」`,orderTitle: 'kev BOT',sellerJid: `Xd`,thumbnail: fakeimg}}}
